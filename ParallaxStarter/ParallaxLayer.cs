...
namespace ParallaxStarter
{
    ...
    {
        public List<ISprite> Sprites = new List<ISprite>();             //list of ISprites that compose this parallax layer
        SpriteBatch spriteBatch;                                        //spritebatch to use to draw layer
